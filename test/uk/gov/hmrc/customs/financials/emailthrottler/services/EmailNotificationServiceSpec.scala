...
class EmailNotificationServiceSpec extends WordSpec with MockitoSugar with MustMatchers with FutureAwaits with DefaultAwaitTimeout {
  ...
  trait EmailNotificationServiceScenario {
    ...
    val emailNotificationService = new EmailNotificationService(mockHttpClient)
  }
